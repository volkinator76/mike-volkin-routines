...
|------|----------------|-----------------|-------|
| 2026-06-26 | — | — | MailerLite MCP server unavailable — did not connect this session |
...
|-----------------|--------|-------|
| 2026-06-26T00:00:00Z | BLOCKED | MailerLite MCP server failed to connect (3rd consecutive failure). No subscriber data retrieved. Action required: verify MailerLite MCP server config and OAuth in Claude Code settings. |
