...
| 2026-06-19 | — | — | MailerLite MCP server connected but exposed no tools — re-auth required |
...
| 2026-06-19T00:00:00Z | BLOCKED | MailerLite MCP server connected but exposed 0 tools — OAuth re-authorization required to restore access. Please re-auth via Claude Code settings or the MailerLite MCP OAuth flow. |
