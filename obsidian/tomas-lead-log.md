...
|------|----------------|-----------------|-------|
| 2026-06-28 | — | — | MailerLite MCP server unavailable — 3rd consecutive blocked run |
...
|-----------------|--------|-------|
| 2026-06-28T00:00:00Z | BLOCKED | MailerLite MCP server failed to connect — 3rd consecutive blocked run (2026-06-15, 2026-06-21, 2026-06-28). No subscriber data retrieved. Action required: re-authorize MailerLite MCP in Claude Code settings. Interactive OAuth browser flow required; cannot complete unattended. |
