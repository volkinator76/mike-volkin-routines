...
|------|----------------|-----------------|-------|
| 2026-06-20 | — | — | MailerLite MCP not available in unattended session — API key or re-auth required |
...
|-----------------|--------|-------|
| 2026-06-20T00:00:00Z | BLOCKED | MailerLite MCP not available — server did not connect in unattended session. No API key found in environment. Action required: add MAILERLITE_API_KEY to environment secrets or re-authorize OAuth. |
