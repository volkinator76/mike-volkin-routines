...
|------|----------------|-----------------|-------|
| 2026-06-24 | — | — | MailerLite MCP server unavailable — did not connect (3rd consecutive failure) |
...
|-----------------|--------|-------|
| 2026-06-24T00:00:00Z | BLOCKED | MailerLite MCP server failed to connect for 3rd consecutive run (2026-06-15, 2026-06-21, 2026-06-24). No subscriber data retrieved. Action required: re-authorize MailerLite MCP in Claude Code settings. |
