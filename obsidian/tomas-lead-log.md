...
|------|----------------|-----------------|-------|
| 2026-06-23 | — | — | MailerLite MCP server failed to connect — 3rd consecutive blocked run |
...
|-----------------|--------|-------|
| 2026-06-23T00:00:00Z | BLOCKED | MailerLite MCP server failed to connect (3rd consecutive failure). No subscriber data retrieved. Action required: verify MailerLite MCP server config and re-authorize OAuth in Claude Code settings. |
