...
|------|----------------|-----------------|-------|
| 2026-07-01 | — | — | MailerLite MCP server requires re-authorization — data unavailable |
...
|-----------------|--------|-------|
| 2026-07-01T00:00:00Z | BLOCKED | MailerLite MCP server requires OAuth re-authorization. Non-interactive session cannot complete the browser flow. Re-authorize via Claude Code connector settings or `/mcp` in an interactive session. |
