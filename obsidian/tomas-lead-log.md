...
|------|----------------|-----------------|-------|
| 2026-06-29 | — | — | MailerLite MCP server unavailable — 3rd consecutive failure |
...
|-----------------|--------|-------|
| 2026-06-29T00:00:00Z | BLOCKED | MailerLite MCP server failed to connect (3rd consecutive failure: 2026-06-15, 2026-06-21, 2026-06-29). No subscriber data retrieved. Action required: re-authorize MailerLite in Claude Code settings. |
