...
|------|----------------|-----------------|-------|
| 2026-06-25 | — | — | MailerLite MCP server unavailable — tools did not load this session |
...
|-----------------|--------|-------|
| 2026-06-25T00:00:00Z | BLOCKED | MailerLite MCP server connected but exposed no tools. Attempted ToolSearch multiple times — zero MailerLite tools returned. 3rd consecutive blocked run (06-15, 06-21, 06-25). Action required: reconnect/re-authorize MailerLite MCP server in Claude Code settings. |
